...
Task tool (general-purpose):
  ...
  prompt: |
    ...
    **DO:**
    ...
    - If you believe the library itself is at fault, STOP and report `BLOCKED` with the specific file, line, and failure. The coordinator will decide whether to pin, patch via the package manager, or change approach.
